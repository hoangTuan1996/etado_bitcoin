                    ...
                    <div class="card-body">
                        <div class="d-flex">
                            <div class="text-white">
                                <h2 class="mb-0 number-font">{{$count_users}}</h2>
        ...
        <div class="col-sm-12 col-md-6 col-lg-6 col-xl-3">
            <div class="card bg-primary img-card box-primary-shadow">
                <div class="card-body">
                    <div class="d-flex">
                        <div class="text-white">
                            <h2 class="mb-0 number-font">{{$count_accounts}}</h2>
                            <p class="text-white mb-0">Total Accounts </p>
                        </div>
                        <div class="ml-auto"><i class="fa fa-user-circle text-white fs-30 mr-2 mt-2"></i></div>
                    </div>
                </div>
            </div>
        </div><!-- COL END -->
